...
class ProjectsCacheDataStoreTest {
    ...
    fun setProjectAsUnBookmarkedCompletes() {
        ...
        val testObserver = store.setProjectAsUnBookmarked(DataFactory.randomString()).test()
        testObserver.assertComplete()
    }

    @Test
    fun setProjectAsUnBookmarkedCallsCacheStore() {
        val projectId = DataFactory.randomString()
        stubProjectsCacheSetProjectAsUnBookmarked(Completable.complete())
        store.setProjectAsUnBookmarked(projectId).test()
